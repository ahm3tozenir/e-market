          ...
          <div className="divide-y divide-gray-200">
            <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              <div className="relative">
                ...
                <label for="password2" className="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Parolanızı Tekrar Girin</label>
              </div>
              <div className="relative">
                <button className="bg-gradient-to-r from-fuchsia-500 to-cyan-500 hover:scale-105 text-white rounded-md px-2 py-1 ease-in-out duration-200">Kayıt Ol</button>
              </div>
            </div>
          </div>
        </div>
